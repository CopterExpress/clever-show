...
![Скриншот раздела Server](img/server-server.png)
...
![Скриншот раздела Drone](img/server-drone.png)
...
![Скриншот раздела Animation](img/server-animation.png)
...
![Скриншот раздела Music](img/server-music.png)
...
![Скриншот боковой панели](img/server_sidemenu.png)
 ...
 * `Pause/Resume` - ставит на паузу и возобновляет выполнение полётных задач. После каждого нажатия кнопка меняет состояние на обратное.
