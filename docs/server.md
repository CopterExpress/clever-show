 ...
 * `broadcast_port` - UDP порт, по которому будет осуществляться отправка сообщений. *Рекомендуется изменить значение по умолчанию.* Внимание! При изменении этого 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTc5NDQxODEsOTM2NTcxMzg4LDg3MjY4MD
YxOF19
-->