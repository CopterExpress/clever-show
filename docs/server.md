 ...
 * `broadcast_port` - UDP порт, по которому будет осуществляться отправка сообщений. *Рекомендуется изменить значение по умолчанию.* Внимание! При изменении этого параметра клиенты не смогут принимать сообщения автоконфигурации до изменения 
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ1MzgwODExLDkzNjU3MTM4OCw4NzI2OD
A2MThdfQ==
-->