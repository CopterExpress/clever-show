...
* Кнопка `Start animation` - По истечению заданного в `Start after` времени, все выбранные коптеры совершат взлётные процедуры и *синхронно* выполнят 
*
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTk1MTM1MTUxLC01MDIzODYyNjMsLTI5ND
