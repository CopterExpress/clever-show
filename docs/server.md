...
* Кнопка `Start animation` - По истечению заданного в `Start after` времени, все выбранные коптеры совершат взлётные процедуры и *синхронно* выполнят полётное задание (анимацию). По окончанию анимации все коптеры выполнят посадку *на месте окончания своей анимации*.
*
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMjMxOTYzMzMsLTUwMjM4NjI2MywtMj
k0OTcwNzI4LDkzNjU3MTM4OCw4NzI2ODA2MThdfQ==
-->