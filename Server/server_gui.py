...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.flip_button)
        self.fly_button = QtWidgets.QPushButton(self.centralwidget)
        self.fly_button.setObjectName("fly_button")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.fly_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fly_button.setText(_translate("MainWindow", "Fly to point"))
